...
echo "[I] Shutting down and removing Bamboo container."
...
echo "[I] Removing Bamboo and PostgreSQL persistent data."
...
echo "[I] Restoring Bamboo home directory."
if [ ! -d volumes/web ]; then
    mkdir -p volumes/web
fi
mv backups/tmp_restore/home volumes/web/data/

echo "[I] Creating and starting Bamboo container."
